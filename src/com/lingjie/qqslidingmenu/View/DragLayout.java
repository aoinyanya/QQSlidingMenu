...
public class DragLayout extends FrameLayout {
	...
	/*
	 * 当DragLayout的xml布局的结束标签被读取完成会执行该方法,此时会知道自己有几个子view 一般用来初始化子view的引用
	 */
	@Override
	 ...
	 * heightMeasureSpec); //测量自己的子view //float dimension =
	 * getResources().getDimension(R.dimen.width); int measureSpecWidth =
	 * MeasureSpec.makeMeasureSpec(view.getLayoutParams().width,
	 * MeasureSpec.EXACTLY); int measureSpecHeight =
	 * MeasureSpec.makeMeasureSpec(view.getLayoutParams().height,
	 * MeasureSpec.EXACTLY); view.measure(measureSpecWidth, measureSpecHeight);
	 * }
	 */
